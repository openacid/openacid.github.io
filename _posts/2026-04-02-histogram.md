...
When we were building [Databend](https://github.com/databendlabs/databend) and [OpenRaft](https://github.com/databendlabs/openraft),
...
This article explains the design behind [base2histogram](https://github.com/drmingdrmer/base2histogram), the library we built to solve it.
...
A [histogram](https://en.wikipedia.org/wiki/Histogram) is the natural tool here — plot latency on the x-axis, request count on the y-axis, and you get an immediate picture of where time is being spent.

![001-latency histogram](/post-res/histogram/d0883e49611bab5c-001-article-latency.png)
...
-   **Queryable for [percentiles](https://en.wikipedia.org/wiki/Percentile)** — P50, P95, P99
...
Most requests cluster around some typical latency, with a few outliers on both ends. This is a [log-normal distribution](https://en.wikipedia.org/wiki/Log-normal_distribution) — take the log of the latency values, and the shape becomes a classic [bell curve](https://en.wikipedia.org/wiki/Normal_distribution).

The signature look: a peak at lower values, then a gradual [long tail](https://en.wikipedia.org/wiki/Long_tail) stretching to the right.

![](/post-res/histogram/1e4a9be7908c5de8-002-lognormal-distribution.png)
...
So the buckets need to grow on a **[log scale](https://en.wikipedia.org/wiki/Logarithmic_scale)**, not a **linear** one.

The simplest version of this: each bucket is twice as wide as the one before it.

`[0,1), [1,2), [2,4), [4,8), [8,16), ...`

Why powers of 2? Because multiplying by 2 is free on a CPU, and mapping a value to its bucket takes a single [leading zero count](https://en.wikipedia.org/wiki/Find_first_set#CLZ) instruction.
...
![](/post-res/histogram/0587ffc4d78c5e01-003-log2-bucketing.png)
...
![](/post-res/histogram/823fba54ce3daa43-004-log2-coarse.png)
...
![](/post-res/histogram/4431414f6473152b-005-1.1x-buckets.png)
...
Think of a bucket's lower bound as a tiny [floating-point number](https://en.wikipedia.org/wiki/Floating-point_arithmetic).
The [MSB](https://en.wikipedia.org/wiki/Bit_numbering#Most_significant_bit) position gives you the exponent (which group of buckets you're in),
...
![](/post-res/histogram/077aac24f7b55056-006-bit-decomposition.png)
...
![](/post-res/histogram/126a7a9d50366663-007-bucket-layout.png)
...
![](/post-res/histogram/851f5482f43e8c4c-008-trapezoid.png)
...
-   **Uniform ([uniform distribution](https://en.wikipedia.org/wiki/Continuous_uniform_distribution))**: synthetic benchmarks
-   **LN-API ([log-normal](https://en.wikipedia.org/wiki/Log-normal_distribution) σ=0.5)**: API and microservice latency
-   **Bimodal ([bimodal distribution](https://en.wikipedia.org/wiki/Multimodal_distribution))**: cache hit/miss — 90% fast path ~500μs, 10% slow path ~50ms
-   **Expon ([exponential distribution](https://en.wikipedia.org/wiki/Exponential_distribution))**: network and I/O waits
-   **LN-DB (log-normal σ=1.0)**: database query latency, with a wider tail
-   **Sequent (sequential)**: adversarial worst case
-   **Pareto ([Pareto distribution](https://en.wikipedia.org/wiki/Pareto_distribution) α=1.5)**: heavy-tailed workloads like request sizes
...
-   Code: [base2histogram](https://github.com/drmingdrmer/base2histogram)
...
- Databend : [https://github.com/databendlabs/databend](https://github.com/databendlabs/databend)

- MSB : [https://en.wikipedia.org/wiki/Bit_numbering#Most_significant_bit](https://en.wikipedia.org/wiki/Bit_numbering#Most_significant_bit)

- OpenRaft : [https://github.com/databendlabs/openraft](https://github.com/databendlabs/openraft)

- Pareto distribution : [https://en.wikipedia.org/wiki/Pareto_distribution](https://en.wikipedia.org/wiki/Pareto_distribution)

- base2histogram : [https://github.com/drmingdrmer/base2histogram](https://github.com/drmingdrmer/base2histogram)

- bimodal distribution : [https://en.wikipedia.org/wiki/Multimodal_distribution](https://en.wikipedia.org/wiki/Multimodal_distribution)

- exponential distribution : [https://en.wikipedia.org/wiki/Exponential_distribution](https://en.wikipedia.org/wiki/Exponential_distribution)

- floating-point number : [https://en.wikipedia.org/wiki/Floating-point_arithmetic](https://en.wikipedia.org/wiki/Floating-point_arithmetic)

- histogram : [https://en.wikipedia.org/wiki/Histogram](https://en.wikipedia.org/wiki/Histogram)

- iopsystems/histogram : [https://github.com/iopsystems/histogram](https://github.com/iopsystems/histogram)

- leading zero counting : [https://en.wikipedia.org/wiki/Find_first_set#CLZ](https://en.wikipedia.org/wiki/Find_first_set#CLZ)

- log scale : [https://en.wikipedia.org/wiki/Logarithmic_scale](https://en.wikipedia.org/wiki/Logarithmic_scale)
...
- long tail : [https://en.wikipedia.org/wiki/Long_tail](https://en.wikipedia.org/wiki/Long_tail)

- normal distribution : [https://en.wikipedia.org/wiki/Normal_distribution](https://en.wikipedia.org/wiki/Normal_distribution)

- percentile : [https://en.wikipedia.org/wiki/Percentile](https://en.wikipedia.org/wiki/Percentile)

- uniform distribution : [https://en.wikipedia.org/wiki/Continuous_uniform_distribution](https://en.wikipedia.org/wiki/Continuous_uniform_distribution)
