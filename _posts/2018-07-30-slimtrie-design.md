...
![](/post-res/slimtrie-design/cc3215bc7ce3207f-slim-1-01.png)
...
![](/post-res/slimtrie-design/e99f2c0ac48cd587-slim-1-02.png) ![](/post-res/slimtrie-design/38bc609f90187efb-slim-1-03.png)
...
![](/post-res/slimtrie-design/083f100228cd4531-slim-1-04.jpg)
...
![](/post-res/slimtrie-design/a767fb4bde876230-slim-1-05.jpg)
...
![](/post-res/slimtrie-design/2170df2396292bb2-slim-1-06.png)
...
![](/post-res/slimtrie-design/5de9dbf9d5b1eef8-slim-1-07.png)

可以得出明显结论：

1.  SlimTrie 作为索引在内存占用上显著低于map 和B-Tree 。
1.  SlimTrie 作为索引其内存占用的决定因素是value 的大小，与key 的大小无关。
...
![](/post-res/slimtrie-design/06a4504575d5adf4-slim-1-08.png)
...
![](/post-res/slimtrie-design/59a8ebaae37f93ff-slim-1-09.png)

查询相同的确定不存在的key 的查询时间的比较结果如下图：

不存在的key 的查找耗时对比图(越小越优)：

![](/post-res/slimtrie-design/fda08ce3f2af1b28-slim-1-10.png)
