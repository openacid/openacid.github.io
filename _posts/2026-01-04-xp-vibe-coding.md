...
1.  **描述需求** — 用语音输入把想法描述出来
1.  **代码生成** — 交给 AI 命令行工具生成代码
1.  **审核与提交** — 用 tig 逐行 review，增量提交到 Git
...
![workflow](/post-res/xp-vibe-coding/ef3c8085ef56b7b8-workflow.webp)

---

## 第一步：分析与决策 — Rust Rover

[Rust Rover](https://www.jetbrains.com/rust/) 是 JetBrains 开发的 Rust IDE。JetBrains 的 IDE 系列（IntelliJ IDEA、PyCharm、WebStorm 等）在 AI 时代之前一直是开发者的首选，以代码跳转、重构、调试等功能著称。

虽然 Rust Rover 在 AI 功能上相对保守，但传统的代码跳转、全局搜索等功能依然扎实，足以快速建立对项目的整体认知。

在这个阶段，我主要根据要做的事情回顾代码结构，确定具体的实现思路；或者在没有具体任务时浏览项目，寻找需要改进的地方。

![Rust Rover](/post-res/xp-vibe-coding/5499429f7c2ff0a1-rust-rover.webp)
...
### [豆包桌面版](https://www.doubao.com/)

![豆包](/post-res/xp-vibe-coding/53677e8f2cbbc865-doubao.webp)
...
![智谱语音输入法](/post-res/xp-vibe-coding/264208e2cb986c5f-zhipu.webp)
...
[Claude Code](https://github.com/anthropics/claude-code) 是我的主力工具，CLI 框架成熟，即便不用内置模型，作为命令行交互载体也很高效。

日常开发中，我直接口述需求给 Claude Code，全程不需要键盘打字。

为了简化开发流程（也为了好玩），我买了一个只有三个键的小键盘：一个键触发语音输入，一个键是删除，一个键是回车。目前正在尝试只用这三个键完成日常开发。

![三键小键盘](/post-res/xp-vibe-coding/ba4b118935fc9e66-3-key.webp)

模型用的是 [GLM 4.7](https://open.bigmodel.cn/)（[智谱 AI](https://www.zhipuai.cn/) 发布）。需求描述清晰的话，完成"文字到代码"的转化没问题。与顶尖模型相比，处理抽象需求时有差距，但性价比高，国内网络环境下响应快。

就算说的乱 78 糟, 大模型也知道我说的 `IOarrow` 是 `io::Error`:
![Claude Code](/post-res/xp-vibe-coding/4757c5dfa48f6dc4-claude.webp)
...
![tig](/post-res/xp-vibe-coding/05dc7b8862daff46-tig.webp)
...
- Rust Rover : [https://www.jetbrains.com/rust/](https://www.jetbrains.com/rust/)

- tig : [https://github.com/jonas/tig](https://github.com/jonas/tig)

- 智谱 AI : [https://www.zhipuai.cn/](https://www.zhipuai.cn/)

- 智谱语音输入法 : [https://autoglm.zhipuai.cn/autotyper/](https://autoglm.zhipuai.cn/autotyper/)

- 豆包 : [https://www.doubao.com/](https://www.doubao.com/)

- 闪电说 : [https://shandianshuo.cn/](https://shandianshuo.cn/)
