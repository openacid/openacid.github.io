...
refs:
    - "可靠分布式系统-paxos的直观解释.pdf":  https://blog.openacid.com可靠分布式系统-paxos的直观解释.pdf  "可靠分布式系统-paxos的直观解释"
...
![leslie-dont-know-raft](paxso-leslie-dont-know-raft.png)
