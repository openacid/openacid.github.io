...
![](62b7bb390d222f2e-raft-io-order-fix-banner.webp)
...
1.  If `req.term > current_term`, immediately update `current_term` to `req.term`
1.  Asynchronously submit a save-term IO operation
1.  Eventually update `persisted_term` when the IO completes
